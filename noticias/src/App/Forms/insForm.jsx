...
class InsForm extends React.Component {
        ...
        if (user && email && pass && confiPass) {
            ...
            if (this.state.form.pass.trim() === this.state.form.confiPass.trim()) {
                ...
                if (terms) {
                    ...
                    let consultaCorreo = await this.consultarUsuario(this.state.form.correo, 'email');

                    if (!consultaCorreo) {

                        let consultaUsurio = await this.consultarUsuario(this.state.form.usuario, 'user');
            ...
            if (!user) {
                ...
                swal({
                    text: 'Para verificar que la contraseña este correcta debes verificarla aquí',
                    button: 'Aceptar'
                })
            }
    ...
    render() {
        ...
        const formulario = <div className="container">
            <form className="needs-validation" id="formulario">

                <div className="form-group">
                    <label htmlFor="usuario">usuario:</label>
                    <input type="text" className="form-control" id="usuario" placeholder="Ingresa usuario" onChange={this.handleChange} name="usuario" required />
                    <div className="valid-feedback">valido.</div>
                </div>

                <div className="form-group">
                    <label htmlFor="correo">correo:</label>
                    <input type="email" className="form-control" id="correo" placeholder="Ingresa correo" onChange={this.handleChange} name="correo" required />

                </div>

                <div className="form-group">
                    <label htmlFor="pass">contraseña:</label>
                    <input type="password" className="form-control" id="pass" placeholder="Ingresa contraseña" onChange={this.handleChange} name="pass" required />
                ...
                <div className="form-group">
                    ...
                    <input type="password" className="form-control" id="confiPass" placeholder="Confirme contraseña" onChange={this.handleChange} name="confiPass" required />
                ...
                <div className="form-group form-check" id="checkID">
                    <label className="form-check-label" >
                        <input className="form-check-input" type="checkbox" name="term" id="term" onChange={this.handleChangeTerms} />
            ...
            <Button type={'button'} content={'registrarse'} classType={'Mybtn btn4'} click={() => this.submit()} id={'registrarse'} name={'registrarse'} />
